      ...
      <section className="relative sm:mt-28 mt-14">
        ...
        >
          ...
          <div className="parent sm:absolute sm:right-[10%] sm:-top-[15%] mb-10 sm:mb-0">
            <div className="relative sm:w-72 sm:h-72 w-20 h-20 rotate-45 overflow-hidden sm:rounded-3xl rounded-xl sm:top-20 div1 hover:scale-105 duration-500">
              <img
                src={IntroImg1}
            ...
            <div className="relative sm:w-72 sm:h-72 w-20 h-20 rotate-45 overflow-hidden sm:rounded-3xl rounded-xl sm:left-20 div2 hover:scale-105 duration-500">
              <img
                src={IntroImg2}
            ...
            <div className="relative sm:w-72 sm:h-72 w-20 h-20 rotate-45 overflow-hidden sm:rounded-3xl rounded-xl sm:left-40 sm:-top-20 z-10 div3 hover:scale-105 duration-500">
              <img
                src={IntroImg3}
                alt="Engine pistons surrounded by splashes of golden motor oil; a dynamic representation of lubrication and engine mechanics."
                className="w-full h-full object-cover -rotate-45 scale-150"
            ...
            <div className="relative sm:w-72 sm:h-72 w-20 h-20 rotate-45 overflow-hidden sm:rounded-3xl rounded-xl sm:-top-20 z-10 div4 hover:scale-105 duration-500">
              <img
                src={IntroImg4}
                alt="Engine pistons surrounded by splashes of golden motor oil; a dynamic representation of lubrication and engine mechanics."
                className="w-full h-full object-cover -rotate-45 scale-150"
